...
final class GetCondMoreOrEqValueSortingDescCase extends RecordsSearchTestCase
{
    public function __construct()
    {
        $this->cond = Fit::field('name')->val('>=', 'James');
        $this->sortFields = ['date' => 'desc'];
    }
    ...
    public function getInitStructures(): array
    {
        return [
            ...
            self::build('b95d2f46-a628-45f4-80d1-56a42c3cfdd4', 'Xalina','2007-02-12'),
        ];
    }
