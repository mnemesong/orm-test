...
namespace Mnemesong\OrmTestHelpers\recordsSearch\searchInUuidTables\fieldValueCond\lessOrEq;

use Mnemesong\Fit\Fit;
use Mnemesong\OrmTestHelpers\recordsSearch\abstracts\RecordsSearchTestCase;
use Mnemesong\Structure\Structure;

final class GetCondLessOrEqValueWithSpecialFieldsCase extends RecordsSearchTestCase
{
    public function __construct()
    {
        $this->cond = Fit::field('name')->val('<=', 'James');
        $this->selectFields = ['date'];
    }
    ...
    public function getInitStructures(): array
    {
        return [
            ...
            self::build('f3aa8d28-d4ef-4d66-bbd1-5ccc7f33d333', 'Emmy',null),
        ];
    }
    ...
    {
        return [
            self::buildShort('2022-11-02'),
            self::buildShort('2012-12-02'),
            self::buildShort('2012-11-02'),
     ...
     * @return Structure
     */
    protected static function buildShort(?string $date): Structure
    {
        return new Structure(['date' => $date]);
    }
}