...
final class GetCondLessOrEqUuidValueCase extends RecordsSearchTestCase
{
    public function __construct()
    {
        $this->cond = Fit::field('uuid')->val('<=', '42');
        $this->sortFields = ['uuid' => 'desc'];
    }
    ...
    public function getInitStructures(): array
    {
        return [
            ...
            self::build('41e8413e-45c3-44c8-a1fe-1466bc876fc5', 'Jira','2018-02-12'),
        ];
    }
