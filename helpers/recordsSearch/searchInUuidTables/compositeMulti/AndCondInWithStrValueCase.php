...
namespace Mnemesong\OrmTestHelpers\recordsSearch\searchInUuidTables\compositeMulti;

use Mnemesong\Fit\Fit;
use Mnemesong\OrmTestHelpers\recordsSearch\abstracts\RecordsSearchTestCase;
use Mnemesong\Structure\Structure;

final class AndCondInWithStrValueCase extends RecordsSearchTestCase
{
    public function __construct()
    {
        $this->cond = Fit::andThat([
            Fit::field('date')->arr('in', ['2022-11-02', '2020-01-01']),
            Fit::field('count')->val('>', '2')->asStr()
        ]);
    }
