...
namespace Mnemesong\OrmTestHelpers\recordsSearch\searchInUuidTables\fieldArrayCond\notIn;

use Mnemesong\Fit\Fit;
use Mnemesong\OrmTestHelpers\recordsSearch\abstracts\RecordsSearchTestCase;
use Mnemesong\Structure\Structure;

final class GetCondNotInWithStrValueSortedAndLimitedCase extends RecordsSearchTestCase
{
    public function __construct()
    {
        $this->cond = Fit::field('date')->arr('!in', ['2022-11-02', '2020-01-01']);
        $this->sortFields = ['uuid' => 'asc'];
        $this->limit = 1;
    }
