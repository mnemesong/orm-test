...
namespace Mnemesong\OrmTestHelpers\recordsSearch\searchInUuidTables\fieldUnaryCond\null;

use Mnemesong\Fit\Fit;
use Mnemesong\OrmTestHelpers\recordsSearch\abstracts\RecordsSearchTestCase;
use Mnemesong\Structure\Structure;

final class GetCondNotNullValueCase extends RecordsSearchTestCase
{
    public function __construct()
    {
        $this->cond = Fit::field('date')->is('!null');
    }
