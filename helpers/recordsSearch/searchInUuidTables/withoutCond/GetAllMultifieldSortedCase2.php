...
namespace Mnemesong\OrmTestHelpers\recordsSearch\searchInUuidTables\withoutCond;

use Mnemesong\OrmTestHelpers\recordsSearch\abstracts\RecordsSearchTestCase;
use Mnemesong\Structure\Structure;

final class GetAllMultifieldSortedCase2 extends RecordsSearchTestCase
{
    protected array $sortFields = ['name' => 'asc', 'date' => 'desc'];
