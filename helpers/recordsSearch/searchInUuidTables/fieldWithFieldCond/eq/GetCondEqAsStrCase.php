...
class GetCondEqAsStrCase extends RecordsSearchTestCase
{
    public function __construct()
    {
        $this->cond = Fit::field('count')->field('=', 'num')->asStr();
    }
    ...
    {
        return new Structure(['uuid' => $uuid, 'count' => strval($count), 'num' => strval($num)]);
    }
}